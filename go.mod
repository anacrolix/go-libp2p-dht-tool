...
require (
	...
	github.com/coreos/go-semver v0.2.1-0.20180108230905-e214231b295a // indirect
	...
	github.com/libp2p/go-libp2p-interface-connmgr v0.0.1 // indirect
	github.com/libp2p/go-libp2p-net v0.0.1 // indirect
